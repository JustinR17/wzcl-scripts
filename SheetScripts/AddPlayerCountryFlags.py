...
spreadsheet_id = os.environ.get("CL17_SSID")
...
player_links = sheet.get(
    ...
    ranges=[f"Player_Stats!B1:B600"],
    fields="sheets/data/rowData/values/hyperlink",
).execute()

player_countries: List[List[str]] = (
    sheet.values()
    .get(spreadsheetId=spreadsheet_id, range=f"Player_Stats!D1:D600")
    .execute()["values"]
)
